...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SaltFish', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的学牲', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'saltfish.dpdns.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'SaltFish, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个up主, Hi，我是一个学牲,Hi，我是一个干饭人,欢迎来到我的博客🎉',
